...
| 15a  | In Progress | **API Lambda and Gateway Deployment** — Lambda container image, API Gateway HTTP API v2, Secrets Manager runtime config, Terraform IaC, GitHub Actions OIDC deployment. See [docs/operations/aws-api-deployment.md](operations/aws-api-deployment.md). |
